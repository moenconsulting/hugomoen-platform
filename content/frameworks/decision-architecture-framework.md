...
Decision Architecture Framework should currently be viewed as an emerging framework rather than a finished methodology.
...
The goal is not to create another governance model.

The goal is to better understand how organizations can improve their ability to make, challenge, document and learn from decisions over time.